...
public partial class Advqt
{
    ...
    public long? ParentDocKey { get; set; }

    public byte Qtstatus { get; set; }

    public byte Rev { get; set; }

    public byte NextRev { get; set; }

    public string? Reason { get; set; }

    public string? ConfirmUserId { get; set; }

    public string? SucessLostUserId { get; set; }
    ...
    public virtual User? SucessLostUser { get; set; }
