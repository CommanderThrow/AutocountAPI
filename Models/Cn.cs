...
public partial class Cn
{
    ...
    public string? UdfSuperAppId { get; set; }

    public string EinvoiceSubmitDocType { get; set; } = null!;

    public int WithholdingTaxRoundingMethod { get; set; }

    public string SubmitInvoiceNow { get; set; } = null!;

    public string SgeinvoiceSendToPeppol { get; set; } = null!;
    ...
    public long? SgeinvoiceAtdocKey { get; set; }

    public string? SgeinvoiceAtdocNo { get; set; }
