...
public partial class Dept
{
    ...
    public virtual ICollection<Csdtl> Csdtls { get; set; } = new List<Csdtl>();
    ...
    public virtual ICollection<Dept> InverseParentDeptNoNavigation { get; set; } = new List<Dept>();
    ...
    public virtual Dept? ParentDeptNoNavigation { get; set; }

    public virtual ICollection<PastYearPriceHistory> PastYearPriceHistories { get; set; } = new List<PastYearPriceHistory>();
    ...
    public virtual ICollection<PriceBookRule> PriceBookRuleFromDeptNoNavigations { get; set; } = new List<PriceBookRule>();

    public virtual ICollection<PriceBookRule> PriceBookRuleToDeptNoNavigations { get; set; } = new List<PriceBookRule>();
