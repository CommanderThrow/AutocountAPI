...
public partial class User
{
    ...
    public virtual ICollection<C> CCreatedUsers { get; set; } = new List<C>();

    public virtual ICollection<C> CLastModifiedUsers { get; set; } = new List<C>();
    ...
    public virtual ICollection<PocketSyncProfile> PocketSyncProfiles { get; set; } = new List<PocketSyncProfile>();
    ...
    public virtual ICollection<X> XCreatedUsers { get; set; } = new List<X>();

    public virtual ICollection<X> XLastModifiedUsers { get; set; } = new List<X>();
