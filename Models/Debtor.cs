...
public partial class Debtor
{
    ...
    public string? DoNotSubmitEinvoice { get; set; }

    public string? SgeinvoicePeppolId { get; set; }

    public string? SgeinvoiceBusinessUnit { get; set; }

    public string? UdfJantina { get; set; }

    public string? UdfBangsa1 { get; set; }

    public string? UdfBangsa2 { get; set; }

    public string? UdfKerakyatan { get; set; }

    public DateTime? UdfTarikhLahir { get; set; }
