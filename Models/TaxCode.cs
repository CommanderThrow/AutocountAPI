...
public partial class TaxCode
{
    ...
    public virtual ICollection<C> CFooter1TaxCodeNavigations { get; set; } = new List<C>();

    public virtual ICollection<C> CFooter2TaxCodeNavigations { get; set; } = new List<C>();

    public virtual ICollection<C> CFooter3TaxCodeNavigations { get; set; } = new List<C>();
    ...
    public virtual ICollection<X> XFooter1TaxCodeNavigations { get; set; } = new List<X>();

    public virtual ICollection<X> XFooter2TaxCodeNavigations { get; set; } = new List<X>();

    public virtual ICollection<X> XFooter3TaxCodeNavigations { get; set; } = new List<X>();
