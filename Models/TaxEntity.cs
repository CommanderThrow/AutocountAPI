...
public partial class TaxEntity
{
    ...
    public virtual ICollection<EinvoiceSelfBilled> EinvoiceSelfBilledBuyerTaxEntities { get; set; } = new List<EinvoiceSelfBilled>();

    public virtual ICollection<EinvoiceSelfBilled> EinvoiceSelfBilledDeliveryTaxEntities { get; set; } = new List<EinvoiceSelfBilled>();

    public virtual ICollection<EinvoiceSelfBilled> EinvoiceSelfBilledSupplierTaxEntities { get; set; } = new List<EinvoiceSelfBilled>();
    ...
    public virtual ICollection<X> Xes { get; set; } = new List<X>();
